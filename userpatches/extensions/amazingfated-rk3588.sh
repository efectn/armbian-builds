...
function post_install_kernel_debs__amazingfated_rk358() {
	...
	chroot_sdcard cat > /etc/apt/preferences.d/amazingfated-rk3588-panfork-pin <<EOF
Package: *
Pin: release o=LP-PPA-liujianfeng1994-panfork-mesa
Pin-Priority: 1001
EOF

	chroot_sdcard cat > /etc/apt/preferences.d/amazingfated-rk3588-rockchip-multimedia-pin <<EOF
Package: *
